...
export const biViews: BiView[] = [
  ...
  {
    id: 'rep-performance',
    question: 'How is each representative tracking against the same period last year?',
    answer:
      'Four of six are ahead of last year. Rep C is the one to look at, down against a strong prior period, while Rep E has grown the most in absolute terms.',
    method:
      'Sales are grouped by representative and compared against the matching period in the previous year, so growth is read against that representative rather than against the team average.',
    chart: {
      kind: 'compare',
      unit: 'units sold',
      series: ['This year', 'Last year'],
      points: [
        { label: 'Rep A', a: 148, b: 132 },
        { label: 'Rep B', a: 121, b: 118 },
        { label: 'Rep C', a: 96, b: 127 },
        { label: 'Rep D', a: 134, b: 129 },
        { label: 'Rep E', a: 171, b: 140 },
        { label: 'Rep F', a: 88, b: 94 },
      ],
    },
  },
  {
